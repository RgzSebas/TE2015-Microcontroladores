# 1 "GPIO_configuration.s"
# 1 "<built-in>" 1
# 1 "GPIO_configuration.s" 2
PROCESSOR 18F57Q43
...
; EL LED DE LA TARJETA DE DESARROLLO ESTÁ CONECTADO AL PIN ((PORTF) and 0FFh), 3, a
; EL BOTÓN DE LA TARJETA DE DESARROLLO ESTÁ CONECTADO AL PIN ((PORTB) and 0FFh), 4, a
...
main:
    ...
    BCF ANSELB,4,1 ; ((PORTB) and 0FFh), 4, a COMO PIN DIGITAL
    BANKSEL WPUB ; SELECCIONAR BANCO WPUB
    BSF WPUB,4,1 ; ((PORTB) and 0FFh), 4, a CON RESISTENCIA PULL-UP HABILITADA

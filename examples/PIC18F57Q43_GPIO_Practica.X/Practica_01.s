...
main:
    ...
    ; VISUALIZAR EN LEDS EL VALOR 10101101b

    ; a = 0 para acceso rápido
    ; a = 1 para Bank Select Register

    ; Configuración de GPIO
    ; LEDS CONECTADOS AL PUERTO A
    CLRF    TRISA, 0		; Configurar puerto B como salida
    BANKSEL ANSELA		; Banco 4
    CLRF    ANSELA,1		; Líneas de Puerto C como digitales, por BSR
    MOVLW   10101101		; Cargar valor deseado a WREG

loop:
    MOVWF   LATA,0		; Mover contenido de WREG a Puerto a
    goto loop
END